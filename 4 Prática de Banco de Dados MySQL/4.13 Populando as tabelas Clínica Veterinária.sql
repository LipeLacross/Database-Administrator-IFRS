-- Populando o banco de dados `clinicavet`

-- Inserindo dados na tabela `animals`
...
-- Inserindo dados na tabela `owners`
...
-- Inserindo dados na tabela `specializations`
...
-- Inserindo dados na tabela `species`
INSERT INTO `species` (`ID`, `name`) VALUES
                                         (1, 'Pokemon'),
                                         (2, 'Digimon');

-- Inserindo dados na tabela `vets`
...
-- Inserindo dados na tabela `visits`
